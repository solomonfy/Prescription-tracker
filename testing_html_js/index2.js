...
function displayPrescription(prescription) {
  ...
  if (prescription.prescription_taken === false) {
    ...
    editATag.addEventListener("click", () => {
      ...
      editPrescriptionForm.children[3].value = prescription.medication_imprint;
      editPrescriptionForm.children[4].value = prescription.medication_image;
      ...
      document.querySelector("input.imprint").value = prescription.medication_imprint;
      ...
      editPrescriptionForm.addEventListener("submit", () => {
        ...
        let med_imprint = event.target[3].value;
        let med_image = event.target[4].value;
        ...
        configObj = {
          ...
          body: JSON.stringify({
            ...
            medication_imprint: med_imprint,
            medication_image: med_image,
          }),
        };
