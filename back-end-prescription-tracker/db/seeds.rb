...
8.times do
    Prescription.create(user: User.all.sample, medication: Medication.all.sample, unique_id: Faker::Alphanumeric.alphanumeric(number: 10, min_alpha: 3, min_numeric: 7), frequency: ["Once", "Twice", "Three times", "Four times"].sample, dose: ["Half", "One", "One and half", "Two", "Two and half"].sample, time_to_take: ["6 AM", "7 AM", "8 AM", "9 AM", "10 AM", "11 AM", "12 PM", "1 PM", "2 PM", "3 PM", "4 PM", "5 PM", "6 PM", "7 PM", "8 PM", "9 PM", "10 PM", "11 PM", "12 AM", "1 AM", "2 AM", "3 AM", "4 AM", "5 AM"].sample, date_prescribed: "", doctor_name: Faker::Name.name)
end
